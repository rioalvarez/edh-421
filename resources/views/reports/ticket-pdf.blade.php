    ...
    <div class="two-col">
        <div class="section">
            ...
            <table>
                ...
                <tr>
                    <td>{{ \App\Enums\TicketCategory::tryLabel($category) }}</td>
        ...
        <div class="section">
            ...
            <table>
                ...
                <tr>
                    <td>{{ \App\Enums\TicketPriority::tryLabel($priority) }}</td>
                    <td style="text-align: right;">{{ $count }}</td>
                </tr>
                @endforeach
            </table>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ \App\Enums\TicketCategory::tryLabel($ticket->category) }}</td>
                    <td>
                        <span class="badge badge-{{ $ticket->priority }}">
                            {{ \App\Enums\TicketPriority::tryLabel($ticket->priority) }}
                        </span>
                    </td>
                    <td>{{ Str::limit($ticket->subject, 40) }}</td>
                    <td>
                        <span class="badge badge-{{ $ticket->status }}">
                            {{ \App\Enums\TicketStatus::tryLabel($ticket->status) }}
                        </span>
                    </td>
