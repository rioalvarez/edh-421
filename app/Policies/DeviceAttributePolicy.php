...
class DeviceAttributePolicy
{
    ...
    {
        return $this->canPerform($user, 'view_any_device::attribute');
    }
    ...
    {
        return $this->canPerform($user, 'view_device::attribute');
    }
    ...
    {
        return $this->canPerform($user, 'create_device::attribute');
    }
    ...
    {
        return $this->canPerform($user, 'update_device::attribute');
    }
    ...
    {
        return $this->canPerform($user, 'delete_device::attribute');
    }
    ...
    {
        return $this->canPerform($user, 'delete_any_device::attribute');
    }
    ...
    {
        return $this->canPerform($user, 'reorder_device::attribute');
    }
}
