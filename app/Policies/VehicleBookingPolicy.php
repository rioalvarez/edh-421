...
class VehicleBookingPolicy
{
    ...
    {
        return $user->can('view_any_vehicle::booking');
    }
    ...
    {
        return $user->can('view_vehicle::booking');
    }
    ...
    {
        return $user->can('create_vehicle::booking');
    }
    ...
    {
        return $user->can('update_vehicle::booking');
    }
    ...
    {
        return $user->can('delete_vehicle::booking');
    }
    ...
    {
        return $user->can('delete_any_vehicle::booking');
    }
